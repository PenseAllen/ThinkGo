...
Many programming languages have mini-languages inside them. Go has the time
...
can change the order of the elements however you like, but `1` or `01` will
always stand for the month, `2` or `02` represent the day, `3` or `03` are the
hour, etc.
